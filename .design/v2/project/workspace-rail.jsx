...
function RightRail({ activePart, activeDiff, onJumpBack, onClose }) {
  const hasContext = !!(activePart || activeDiff);
  return (
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center",
      ...
      <div>
        ...
        <div style={{ marginTop:4, fontSize:12, maxWidth:260, lineHeight:1.55 }}>
...
Object.assign(window, { RightRail, Minimap, TokensPanel, FilesPanel, InspectorEmpty });
